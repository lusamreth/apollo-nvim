...
_G.packer_plugins = {
  ...
  ["impatient.nvim"] = {
    loaded = true,
    path = "/home/lusamreth/.local/share/nvim/site/pack/packer/start/impatient.nvim",
  ...
  ["nvim-lsp-installer"] = {
    loaded = true,
    path = "/home/lusamreth/.local/share/nvim/site/pack/packer/start/nvim-lsp-installer",
