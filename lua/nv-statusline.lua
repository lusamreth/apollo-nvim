...
local padding = function(pad, bg)
	...
	return nest(uniq_padding_count .. "pad", {
		provider = function()
...
local txt_percentage = nest("TextPercentage", {
	provider = function()
...
local leftlinked = link_component("right", {
	nest(
		"filename",
...
local rightlinked = link_component("left", {
	freebsd,
	nest(
		"ViMode",
...
--FileTypeName
make_gls_sections("short_line_left", {
...
make_gls_sections("short_line_right", {
