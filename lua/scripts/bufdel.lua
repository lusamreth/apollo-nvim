...
--Cycle through buffers according to their number. This is especially helpful when using a bufferline: we get the same behavior as closing tabs in Chrome / Firefox (see demo).
